...
<form name='f1' method='get' action='View_Articles3.jsp'>
...
String str="select Article_Id,Subject from Articles where DeptName=(Select DName from Employ where Emp_Id='"+eid+"')";
...
str="select Article_Id from Articles where DeptName=(Select DName from Employ where Emp_Id='"+eid+"')";
