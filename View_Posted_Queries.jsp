...
<form name='f1' method='get' action='Set_Answer.jsp'>
...
String str="select QID,Question from Questions where Dept_Name=(Select Dept_Name from Students where Reg_No='"+eid+"') and Response='Active' and Res_Date>#"+st1+"# order by QID";
	//out.println(str);
...
str="select QID from Questions where Dept_Name=(Select Dept_Name from Students where Reg_No='"+eid+"') and Response='Active'";
