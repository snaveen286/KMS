...
<%
   try
	...
	String str="select QID,Question,Response from Questions where Response not in ('Active') and Dept_Name=(Select DName from Employ where Emp_Id='"+eid+"') order by QID";
